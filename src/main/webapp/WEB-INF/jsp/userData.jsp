...
<%@page import="com.mycompany.rhmirrorcloud.UserPC"%>
<%@page import="com.mycompany.rhmirrorcloud.SystemDetail"%>
<%@page import="com.mycompany.rhmirrorcloud.User"%>
                    ...
                    <ul class="right hide-on-med-and-down">
                        ...
                        <li>
                            ...
                            <span style="color:black;">
                                ...
                                if(user==null)
                                {
                                    String site = new String("RHMirrorCloud");
